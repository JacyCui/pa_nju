...
instr_func opcode_entry[256] = {
    /* 0x00 - 0x03*/ add_r2rm_b, add_r2rm_v, add_rm2r_b, inv,
    ...
    /* 0x60 - 0x63*/ inv/*pusha*/, inv/*popa*/, inv, inv,
    ...
    /* 0x8c - 0x8f*/ inv, lea_rm2r_v, inv/*mov_rm2s_w*/, inv,
    ...
    /* 0xcc - 0xcf*/ inv, inv/*int_*/, inv, inv/*iret*/,
    ...
    /* 0xe8 - 0xeb*/ call_i_near, jmp_i_near, inv, jmp_i_short_,
...
instr_func group_7_entry[8] =
    {inv, inv, lgdt_i_near, inv/*lidt*/, inv, inv, inv, inv};
...
instr_func opcode_2_byte_entry[256] = {
    ...
    /* 0x20 - 0x23*/ inv/*mov_c2r_l*/, inv, inv/*mov_r2c_l*/, inv,
