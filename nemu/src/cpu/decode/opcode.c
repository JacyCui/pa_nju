...
instr_func opcode_entry[256] = {
    ...
    /* 0x20 - 0x23*/ inv, and_r2rm_v, and_rm2r_v, inv,
    ...
    /* 0x38 - 0x3b*/ inv, cmp_r2rm_v, inv, cmp_rm2r_v,
    ...
    /* 0xc0 - 0xc3*/ group_2_b, group_2_v, inv/*ret_near_imm16*/, ret_near,
...
instr_func group_3_v_entry[8] =
    {inv, inv, not_rm_v, inv, mul_rm2a_v, imul_rm2a_v, inv, idiv_rm2a_v};
